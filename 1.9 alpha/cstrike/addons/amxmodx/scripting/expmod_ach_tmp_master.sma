...
#define PLUGIN "ExpMod Achievement Gwozdziarka"
#define VERSION "1.0"
#define AUTHOR "tomcionek15 & grs4"

#define WEAP CSW_TMP

new const szNameI[] = "Mistrz Gwozdziarki I";
new const szNameII[] = "Mistrz Gwozdziarki II";
new const szNameIII[] = "Mistrz Gwozdziarki III";

new const szDescI[] = "Zabij z TMP 50 wrogow";
new const szDescII[] = "Zabij z TMP 100 wrogow";
new const szDescIII[] = "Zabij z TMP 200 wrogow";

new szAwardI = 5000;
new szAwardII = 8000;
new szAwardIII = 13000;
