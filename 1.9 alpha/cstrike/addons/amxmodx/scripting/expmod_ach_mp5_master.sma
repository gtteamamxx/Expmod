...
#define PLUGIN "ExpMod Achievement MP5"
#define VERSION "1.0"
#define AUTHOR "tomcionek15 & grs4"

#define WEAP CSW_MP5NAVY

new const szNameI[] = "Mistrz MP5 I";
new const szNameII[] = "Mistrz MP5 II";
new const szNameIII[] = "Mistrz MP5 III";

new const szDescI[] = "Zabij z MP5 170 wrogow";
new const szDescII[] = "Zabij z MP5 370 wrogow";
new const szDescIII[] = "Zabij z MP5 650 wrogow";
