...
#define PLUGIN "ExpMod Achievement DEAGLE"
#define VERSION "1.0"
#define AUTHOR "tomcionek15 & grs4"

#define WEAP CSW_DEAGLE

new const szNameI[] = "Mistrz Deagla I";
new const szNameII[] = "Mistrz Deagla II";
new const szNameIII[] = "Mistrz Deagla III";

new const szDescI[] = "Zabij z Deagla 150 wrogow";
new const szDescII[] = "Zabij z Deagla 350 wrogow";
new const szDescIII[] = "Zabij z Deagla 600 wrogow";

new szAwardI = 3500;
new szAwardII = 6900;
new szAwardIII = 10000;
