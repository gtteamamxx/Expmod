...
#define PLUGIN "ExpMod Achievement Saper"
#define VERSION "1.0"
#define AUTHOR "tomcionek15 & grs4"

new const szNameI[] = "Saper I";
new const szNameII[] = "Saper II";
new const szNameIII[] = "Saper III";

new const szDescI[] = "Rozbroj 25 bomb";
new const szDescII[] = "Rozbroj 50 bomb";
new const szDescIII[] = "Rozbroj 100 bomb";
