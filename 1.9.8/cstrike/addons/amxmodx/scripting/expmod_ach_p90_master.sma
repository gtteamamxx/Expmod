...
#define PLUGIN "ExpMod Achievement P90"
#define VERSION "1.0"
#define AUTHOR "tomcionek15 & grs4"

#define WEAP CSW_P90

new const szNameI[] = "Mistrz P90 I";
new const szNameII[] = "Mistrz P90 II";
new const szNameIII[] = "Mistrz P90 III";

new const szDescI[] = "Zabij z P90 190 wrogow";
new const szDescII[] = "Zabij z P90 380 wrogow";
new const szDescIII[] = "Zabij z P90 570 wrogow";

new szAwardI = 5500;
new szAwardII = 9000;
new szAwardIII = 14900;
