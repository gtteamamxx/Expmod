...
#define PLUGIN "ExpMod Achievement Snajper"
#define VERSION "1.0"
#define AUTHOR "tomcionek15 & grs4"

new const szNameI[] = "Mistrz Snajperki I";
new const szNameII[] = "Mistrz Snajperki II";
new const szNameIII[] = "Mistrz Snajperki III";

new const szDescI[] = "Zabij z dowolnej Snajperki 150 wrogow";
new const szDescII[] = "Zabij z dowolnej Snajperki 300 wrogow";
new const szDescIII[] = "Zabij z dowolnej Snajperki 600 wrogow";
...
public DeathMsg()
{
	...
	{
		if(enabled[atakujacy][0] == 1 && (bron == CSW_SCOUT || bron == CSW_SG550 || bron == CSW_AWP || bron == CSW_G3SG1))
			exp_set_achievement_progress(atakujacy, ach[0], 1, exp_get_achievement_progress(atakujacy, ach[0], 1)+1)
		else if(enabled[atakujacy][1] == 1 && (bron == CSW_SCOUT || bron == CSW_SG550 || bron == CSW_AWP || bron == CSW_G3SG1))
			exp_set_achievement_progress(atakujacy, ach[1], 2, exp_get_achievement_progress(atakujacy, ach[1], 2)+1)
		else if(enabled[atakujacy][2] == 1 && (bron == CSW_SCOUT || bron == CSW_SG550 || bron == CSW_AWP || bron == CSW_G3SG1))
