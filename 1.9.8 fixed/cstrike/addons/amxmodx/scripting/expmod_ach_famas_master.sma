...
#define WEAP CSW_FAMAS

new const szNameI[] = "Mistrz Famasa I";
new const szNameII[] = "Mistrz Famasa II";
new const szNameIII[] = "Mistrz Famasa III";

new const szDescI[] = "Zabij z Famasa 200 wrogow";
new const szDescII[] = "Zabij z Famasa 450 wrogow";
new const szDescIII[] = "Zabij z Famasa 800 wrogow";
