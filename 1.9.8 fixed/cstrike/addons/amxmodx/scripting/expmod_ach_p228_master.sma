...
#define PLUGIN "ExpMod Achievement P228"
#define VERSION "1.0"
#define AUTHOR "tomcionek15 & grs4"

#define WEAP CSW_P228
new const szNameI[] = "Mistrz P228 I";
new const szNameII[] = "Mistrz P228 II";
new const szNameIII[] = "Mistrz P228 III";

new const szDescI[] = "Zabij z P228 100 wrogow";
new const szDescII[] = "Zabij z P228 250 wrogow";
new const szDescIII[] = "Zabij z P228 550 wrogow";
