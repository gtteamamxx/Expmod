...
public SprawdzAch(id, achid)
{
	...
	if(postep_achI[id][achid] >= PotrzebaI[achid] && status_achI[id][achid] == 1)
	{
		...
		tutorMake(id, TUTOR_GREEN, 5.0, "%L^n%L^n%s^n%L: %d", LANG_PLAYER, "ACH_LEVEL_I", LANG_PLAYER, "ACH_EARNED_ACH", NazwaAchievementI[achid], OpisyAchievementI[achid], LANG_PLAYER, "AWARD", NagrodaI[achid])
		ColorChat(id, GREEN, "%s^x01 %L", prefix, LANG_PLAYER, "ACH_LEVEL_I")
		ColorChat(id, GREEN, "%s^x01 %L", prefix, LANG_PLAYER, "ACH_EARNED_ACH", NazwaAchievementI[achid])
		ColorChat(id, GREEN, "%s^x01 %s", prefix, OpisyAchievementI[achid])
		ColorChat(id, GREEN, "%s^x01 %L: %d", prefix, LANG_PLAYER, "AWARD", NagrodaI[achid])
	...
	else if(postep_achII[id][achid] >= PotrzebaII[achid] && status_achII[id][achid] == 1)
	{
		...
		tutorMake(id, TUTOR_GREEN, 5.0, "%L^n%L^n%s^n%L: %d", LANG_PLAYER, "ACH_LEVEL_II", LANG_PLAYER, "ACH_EARNED_ACH", NazwaAchievementII[achid], OpisyAchievementII[achid], LANG_PLAYER, "AWARD", NagrodaII[achid])
		ColorChat(id, GREEN, "%s^x01 %L", prefix, LANG_PLAYER, "ACH_LEVEL_II")
		ColorChat(id, GREEN, "%s^x01 %L", prefix, LANG_PLAYER, "ACH_EARNED_ACH", NazwaAchievementII[achid])
		ColorChat(id, GREEN, "%s^x01 %s", prefix, OpisyAchievementII[achid])
		ColorChat(id, GREEN, "%s^x01 %L: %d", prefix, LANG_PLAYER, "AWARD", NagrodaII[achid])
	...
	else if(postep_achIII[id][achid] >= PotrzebaIII[achid] && status_achIII[id][achid] == 1 )
	{
		...
		postep_achIII[id][achid] = 0
		tutorMake(id, TUTOR_GREEN, 5.0, "%L^n%L^n%s^n%L: %d", LANG_PLAYER, "ACH_LEVEL_III", LANG_PLAYER, "ACH_EARNED_ACH", NazwaAchievementIII[achid], OpisyAchievementIII[achid], LANG_PLAYER, "AWARD", NagrodaIII[achid])
		ColorChat(id, GREEN, "%s^x01 %L", prefix, LANG_PLAYER, "ACH_LEVEL_III")	
		ColorChat(id, GREEN, "%s^x01 %L", prefix, LANG_PLAYER, "ACH_EARNED_ACH", NazwaAchievementIII[achid])
		ColorChat(id, GREEN, "%s^x01 %s", prefix, OpisyAchievementIII[achid])
		ColorChat(id, GREEN, "%s^x01 %L: %d", prefix, LANG_PLAYER, "AWARD", NagrodaIII[achid])
