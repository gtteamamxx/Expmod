...
#define PLUGIN "ExpMod Achievement FIVESEVEN"
#define VERSION "1.0"
#define AUTHOR "tomcionek15 & grs4"

#define WEAP CSW_FIVESEVEN

new const szNameI[] = "Mistrz Fivesevena I";
new const szNameII[] = "Mistrz Fivesevena II";
new const szNameIII[] = "Mistrz Fivesevena III";

new const szDescI[] = "Zabij z Fivesevena 100 wrogow";
new const szDescII[] = "Zabij z Fivesevena 250 wrogow";
new const szDescIII[] = "Zabij z Fiveseven 550 wrogow";

new szAwardI = 3900;
new szAwardII = 7500;
new szAwardIII = 11300;
