...
#define PLUGIN "ExpMod Mission Jak dziecko..."
#define VERSION "1.0"
...
new nazwa[] = "Jak dziecko..."
new opis[]  = "Zabij z dowolnego pistoletu 200 wrogow"
new wymagany_lvl = 100
new nagroda = 9200
new ile_czego = 200
...
public DeathMsg()
{
	...
	{
		if(enabled[atakujacy] && (bron == CSW_USP || bron == CSW_GLOCK18 || bron == CSW_P228 || bron == CSW_DEAGLE || bron == CSW_FIVESEVEN || bron == CSW_ELITE)) {
