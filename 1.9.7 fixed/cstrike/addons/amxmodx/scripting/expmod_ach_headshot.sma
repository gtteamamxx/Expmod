...
#define PLUGIN "ExpMod Achievement HeadShot"
#define VERSION "1.0"
#define AUTHOR "tomcionek15 & grs4"

new const szNameI[] = "HeadShot I";
new const szNameII[] = "HeadShot II";
new const szNameIII[] = "HeadShot III";

new const szDescI[] = "Zabij HeadShotem 100 wrogow";
new const szDescII[] = "Zabij HeadShotem 250 wrogow";
new const szDescIII[] = "Zabij HeadShotem 500 wrogow";
...
public DeathMsg()
{
	...
	if(atakujacy != id && get_user_team(atakujacy) != get_user_team(id) && read_data(3))
	{
