...
#define PLUGIN "ExpMod Mission Szybki i Wsciekly"
#define VERSION "1.0"
...
new nazwa[] = "Szybki i Wsciekly"
new opis[]  = "Zabij w jednej rundzie 5 przeciwnikow"
new wymagany_lvl = 14
new nagroda = 2600
new ile_czego = 5  
...
public NowaRunda()
{
	for(new i = 1; i < 33; i++)
	{
		if(!is_user_connected(i) || is_user_hltv(i) || !enabled[i])
			continue;
		if(enabled[i])
