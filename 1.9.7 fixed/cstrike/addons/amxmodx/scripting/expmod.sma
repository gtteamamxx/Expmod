...
public Pokaz(id)
{
	...
	if(!is_user_alive(id) && is_user_connected(id) && !is_user_bot(id))
	{
		...
		ShowSyncHudMsg(id, Message4, "%L : %i / %i | %0.1f%%^n%L : %i  ^n%L : %i", LANG_PLAYER, "EXP", doswiadczenie_gracza[cel], POZIOM[poziom_gracza[cel]+1], dos_cel, LANG_PLAYER, "LEVEL", poziom_gracza[cel],  LANG_PLAYER, "HEALTH", get_user_health(cel))
	...
	else if(is_user_alive(id) && is_user_connected(id) && !is_user_bot(id))
	{
		...
		ShowSyncHudMsg(id, Message4, "[%L : %i / %i | %0.1f%%]^n[%L : %i]^n[%L : %i]^n[%L : %i]", LANG_PLAYER, "EXP", doswiadczenie_gracza[id], POZIOM[poziom_gracza[id]+1], dos,  LANG_PLAYER, "LEVEL", poziom_gracza[id], LANG_PLAYER, "HEALTH", get_user_health(id), LANG_PLAYER, "MONETS", monety_gracza[id])
